...
The BOM may be imported into your dependency management, for example a release version or a https://jenkins.mw.lab.eng.bos.redhat.com/hudson/job/jboss-integration-platform-bom/[SNAPSHOT deployed by Jenkins].
